...
public class MapsActivityCurrentPlace extends AppCompatActivity
    ...
    // A default location (IUT info Lyon, France) and default zoom to use when location permission is
    // not granted.
    private final LatLng mDefaultLocation = new LatLng(45.786204, 4.883546);
